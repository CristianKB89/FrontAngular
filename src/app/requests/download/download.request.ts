...
export class downloadRequest {
  ...
  constructor(getInputs: any) {
    (this.numFilter = getInputs.numFilter),
      (this.textFilter = getInputs.textFilter),
      (this.stateFilter = getInputs.stateFilter);

    this.startDate =
      getInputs.startDate == null
        ? null
        : convertDateToRequest(getInputs.startDate, "date");
    this.endDate =
      getInputs.endDate == null
        ? null
        : convertDateToRequest(getInputs.endDate, "date");
    this.startDateTwo =
      getInputs.startDateTwo == null
        ? null
        : convertDateToRequest(getInputs.startDateTwo, "date");
    this.endDateTwo =
      getInputs.endDateTwo == null
        ? null
        : convertDateToRequest(getInputs.endDateTwo, "date");
